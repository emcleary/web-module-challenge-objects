...
// const salad = {name: "Caesar Salad", price: 10, category: "Lunch"};
// const beer = {name: "Beer", price: 12, category: "Drinks"};
// const chocolateCake = {name: "Chocolate Cake", price: 8, category: "Dessert"};
console.log(createMenuItem('Caesar Salad', 10, "Lunch"));
console.log(createMenuItem('Beer', 9, "Drinks"));
console.log(createMenuItem('Soylent', 1.50, "Dinner"));
...
reviews.push({
    name: "Marvin",
    rating: 0,
    feedback: "This restaurant is nothing compared to The Restaurant at the End of the Universe.",
})
...
function getLongReviews(reviews) {
    const arrNew = [];
    for (let i=0; i < reviews.length; i++) {
	var numWords = reviews[i].feedback.split(' ').length;
	if (numWords > 15) {
	    arrNew.push(reviews[i]);
	}
    }
    return arrNew;
}
...
function carMaker(initOdometerValue) {
    let obj = {
	odometer: initOdometerValue,
